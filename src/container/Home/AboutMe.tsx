...
const AboutMe: React.FC<AboutMeProps> = ({ information, matchesmd }) => {
  ...
  return (
    <div className="bgleft flex-center" id="aboutme">
                  ...
                  >
                    <Grid item lg={6} sm={12}>
                      ...
                      <Typography className="title">
                        {information.education.bachelor}
                      </Typography>
                      <Typography className="title">
                        {information.education.university}
                      </Typography>
                      <Typography className="description">
                        {information.education.gpa}
                      </Typography>
                    </Grid>
                  </Grow>
                  <Grow
